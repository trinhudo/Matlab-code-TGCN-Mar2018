...
%
SimTimes = 5*10^6;            % Monte-Carlo repetitions
%
%% Simulation
%
...
%% plot
% load('dataSim')
surf(alpha,rho,OP_S1_F_ana,'facecolor','none','linestyle',':','marker','none')
hold on
surf(alpha,rho,OP_S1_F_sim,'facecolor','none','linestyle','non','marker','o')
%
zlim([1e-4 1e0])
set(gca, 'ZScale', 'log')
%
...
set(gca,'XTick',0:.5:1)
set(gca,'YTick',0:.5:1)
% set(gca,'ZTick',[10^-6 10^-4 10^-2 10^0])
%
h = plot(NaN,NaN,'k:',NaN,NaN,'ko');
legend(h,'Analysis','Simulation')